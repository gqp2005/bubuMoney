...
import { acceptInvite, createHousehold, findInviteByCode, joinHousehold } from "@/lib/household";
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (inviteCode) {
        ...
        await joinHousehold(invite.householdId, credential.user.uid, invite.createdBy);
        await acceptInvite(invite.inviteId, invite.householdId, credential.user.uid);
